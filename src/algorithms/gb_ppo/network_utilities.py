...
@flax.struct.dataclass
class GBPPONetworkParams:
    policy_params: types.Params
    value_params: types.Params
    target_value_params: types.Params


def make_inference_fn(gb_ppo_networks: GBPPONetworks):
    """Creates the params and inference function for the GBPPO networks."""

    def make_policy(
        params: types.PolicyParams,
        deterministic: bool = False,
    ) -> types.Policy:
        policy_network = gb_ppo_networks.policy_network
...
def make_gb_ppo_networks(
    ...
    """Creates the Policy and Value Networks for GBPPO."""
