...
import src.algorithms.ppo_transformer.network_utilities as ppo_networks
import src.algorithms.ppo_transformer.loss_utilities as loss_utilities
...
def train(
    ...
    policy_params_key, policy_dropout_key, value_key = jax.random.split(global_key, num=3)
    del global_key
    ...
    if restored_checkpoint is None:
        init_params = PPONetworkParams(
            policy_params=network.policy_network.init(
                policy_params_key, policy_dropout_key,
            ),
