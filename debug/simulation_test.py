...
def main(argv):
    ...
    Aineqjax = np.asarray(osc_controller.Aineq_fn(osc_controller.q, osc_data))
    bineq = np.asarray(osc_controller.inequality_constraints(osc_controller.q, osc_data))
    Hjax = np.asarray(osc_controller.H_fn(osc_controller.q, osc_data))
    fjax = np.asarray(osc_controller.f_fn(osc_controller.q, osc_data))
